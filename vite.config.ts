  ...
  css: {
    preprocessorOptions: {
      scss: {
        ...
        additionalData: '@import "../assets/scss/globalBase.scss";@import "../assets/scss/globalVar.scss";@import "../assets/scss/globalMixin.scss";@import "../assets/scss/globalExtend.scss";'
      }
    }
  },
